...
- [ ] Add a short operator runbook for the daemon lifecycle and WAL recovery flow.
- [ ] Add a concise maintainer entrypoint section to the README so a new agent knows which `docs/` files to read first.
